        ...
        <div name='support' className='w-full mt-24'>
            ...
            <div className='max-w-[1240px] mx-auto text-white relative'>
                <div className='px-4 py-12'>
                    ...
                    <p className='py-4 text-3xl text-slate-300'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita ullam velit ex delectus, excepturi sed? Veniam iusto sed quis totam?</p>
                </div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
                    <div className='bg-white rounded-xl shadow-2xl'>
                        <div className='p-8'>
                            ...
                            <p className='text-gray-600 text-xl'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure nam atque ea, dicta voluptatem optio harum assumenda autem iste omnis?</p>
                        </div>
